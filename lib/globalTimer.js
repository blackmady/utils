...
const countdown = ((_a = window.requestAnimationFrame) === null || _a === void 0 ? void 0 : _a.bind(window)) || window.setTimeout.bind(window);
const clearCountdown = ((_b = window.cancelAnimationFrame) === null || _b === void 0 ? void 0 : _b.bind(window)) || window.clearTimeout.bind(window);
/**
 * @description: 生成guid
 * @return string
 */
...
class GlobalTimer {
    ...
    add(opt) {
        var _a;
        const timer = Object.assign(Object.assign({ step: -1, name: guid(), _startTime: this.now(), _lastTime: 0, _durationOfPause: 0, _times: 0, status: timerStatus.finished, start: 0, value: 0, end: 0, interval: 1000 }, opt), { tick: () => { }, timeup: () => { }, reset: () => { }, pause: () => { }, resume: () => { }, on: () => { }, off: () => { } });
